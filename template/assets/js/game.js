...
$(document).ready(function () {
    ...
    if (canvas && canvas.getContext) {
        ...
        preloader.preload(['img/board.jpg', 'img/token1.png', 'img/token2.png'], resetGame);
    }
    else {
...
function drawToken(col, row) {
    ...
    if (currentPlayer == 1) {
        context.drawImage(preloader.getImage('img/token1.png'), x, y)
    }
    else {
        context.drawImage(preloader.getImage('img/token2.png'), x, y)
    }
}
