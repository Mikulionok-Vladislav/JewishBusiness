                ...
                <div class="col-lg-8 col-md-12 col-xs-12">
                    ...
                    <div class="blog-post">
                        ...
                        <div class="post-thumb">
                            <a href="#"><img class="img-fulid" src={{$article->image}} alt=""></a>
                        ...
                        <div class="post-content">
                            <h3 class="post-title"><a href="#">{{$article->name}}</a></h3>
                            <div class="meta">
                                <span class="meta-part"><a href="#"><i class="lni-user"></i> {{$article->username}}</a></span>
                                <span class="meta-part"><i class="lni-calendar"></i><a href="#"> {{$article->post_add_at}}</a></span>
...
{{--                        <!-- Post thumb -->--}}
{{--                        <div class="post-thumb">--}}
{{--                            <a href="#"><img class="img-fulid" src="assets/img/blog/blog2.jpg" alt=""></a>--}}
{{--                            <div class="hover-wrap">--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <!-- End Post post-thumb -->--}}
...
{{--                        <!-- Post thumb -->--}}
{{--                        <div class="post-thumb">--}}
{{--                            <a href="#"><img class="img-fulid" src="assets/img/blog/blog3.jpg" alt=""></a>--}}
{{--                            <div class="hover-wrap">--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <!-- End Post post-thumb -->--}}
